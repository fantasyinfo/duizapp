package com.muhshizou.moneyearningquizapp.Activity;
...
import com.muhshizou.moneyearningquizapp.Adapter.WithdrawHistoryAdapter;
import com.muhshizou.moneyearningquizapp.Model.ProfileModel.ProfileModel;
import com.muhshizou.moneyearningquizapp.Model.WithdrawalModel.Result;
import com.muhshizou.moneyearningquizapp.Model.WithdrawalModel.WithdrawalModel;
import com.muhshizou.moneyearningquizapp.R;
import com.muhshizou.moneyearningquizapp.Util.PrefManager;
import com.muhshizou.moneyearningquizapp.Util.Utility;
import com.muhshizou.moneyearningquizapp.Webservice.AppAPI;
import com.muhshizou.moneyearningquizapp.Webservice.BaseURL;
...
public class WithdrawHistory extends AppCompatActivity {
    ...
    List<com.muhshizou.moneyearningquizapp.Model.ProfileModel.Result> profileList;
                ...
                try {
                    if (response.code() == 200 && response.body().getStatus() == 200) {
                        ...
                        if (response.body().getResult().size() > 0) {
                            profileList = new ArrayList<com.muhshizou.moneyearningquizapp.Model.ProfileModel.Result>();
